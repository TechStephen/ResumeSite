...
import { SiCss3, SiJavascript, SiJava, SiMysql, SiCplusplus, SiPhp, SiFirebase, SiHtml5 } from "react-icons/si";
                ...
                <div className="background-img">
                    <Container>
                        <div className="template-content">
                            <h1 data-aos="fade-down" data-aos-duration="2000">Web Development Course Website</h1>
                            <Row className="t-img-row">                                                                    
                                <Col>
                                    <Image src="p8.png" width="95%" height="95%" data-aos="fade-down-right" data-aos-duration="2000" />
                                </Col>
                                ...
                                <Col>
                                    <Table striped bordered hover size="sm"  variant="light" className="template-tb" data-aos="fade-down-left" data-aos-duration="2000">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><SiHtml5 /> HTML5,  <SiCss3 /> CSS3,  <SiJavascript /> Vanilla Javascript</td>
                                            </tr>
                                        </tbody>
                                    </Table>
                                </Col>
                            ...
                            <Row className="t-row">
                                <Card className=".template-description" style={{ width: '75rem', height: '20rem' }} data-aos="flip-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                                        <Card.Body>
                                            ...
                                            <Card.Text className="t-text">Personal website written during my taking of a Web Development Course out of UNCC. We utilized Forms, Alerts, and intermeddiate Javascript functionality ranging from buttons, alerts, tables, XMLHTTPSRequests, and Ajax</Card.Text>
                                        </Card.Body>
                                </Card>
                            </Row>
                        </div>
