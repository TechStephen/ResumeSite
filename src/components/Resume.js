                ...
                <div className="background-img">
                    <Container>
                        <div className="template-content">
                            <h1 data-aos="fade-down" data-aos-duration="2000">Resume Site</h1>
                            <Row className="t-img-row">                                                                    
                                <Col>
                                    <Image src="p1.png" width="95%" height="95%" data-aos="fade-down-right" data-aos-duration="2000" />
                                </Col>
                            ...
                            <Row className="t-row">
                                <Card style={{ width: '75rem', height: '17.5rem' }} data-aos="flip-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                                        <Card.Body>
                                            <Card.Title className="t-descript"> <MdDescription />  Description</Card.Title>
                                            <Card.Text className="t-text">Single-Page-Application/Progressive-Web-Application made to showcase my abilities as a Programmer/Developer! Components include: Bootstrap-react, React-icons, TypedJS and so on... Deployed build on Netlify</Card.Text>
                                        </Card.Body>
                                </Card>
                            </Row>
                        </div>
