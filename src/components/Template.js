                            ...
                            <Row className="t-row">
                                <Card className=".template-description" style={{ width: '75rem', height: '20rem' }} data-aos="flip-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                                        <Card.Body>
                                            ...
                                            <Card.Text className="t-text">Single-Page-Application/Progressive-Web-Application made to showcase my abilities as a Programmer/Developer. written using ReactJS, HTML5, some JSX syntaxing, and styled using CSS3. Components used include: Bootstrap-react, React-icons, ParticleJS, TypedJS and so on... Deployed build with Netlify.</Card.Text>
                                        </Card.Body>
                                </Card>
                            </Row>
                        </div>
